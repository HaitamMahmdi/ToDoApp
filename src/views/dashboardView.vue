...
<template>
  <button
    @click="asideToggler"
    class="md:hidden relative cursor-pointer z-10 p-5 bg-on-primary w-9 h-9 flex items-center justify-center"
  >
  ...
  <section
    v-show="isAsideOpen"
    id="aside"
    class="w-3xs absolute md:relative left-0 top-0 md:block! dark:bg-on-surface text-on-primary h-[100vh]"
  >
    ...
    <ul id="links" class="text-tiny flex flex-col">
      <li>
        <RouterLink class="flex items-center px-5 py-4 hover:bg-secondary" to=""
